        ...
        <section className="py-12 bg-background">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              ...
              {!loading && featuredProducts.length === 0 && <div className="col-span-full text-center text-muted-foreground">
        ...
        <section className="py-12 bg-muted/30">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              ...
              {!loading && bestSellerProducts.length === 0 && <div className="col-span-full text-center text-muted-foreground">
                ...
                <CardContent className="p-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="rounded-lg overflow-hidden border border-border h-64">
                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3658.3828775628044!2d-46.63841492369895!3d-23.493088778822547!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94cef6a3e3b3b3b3%3A0x3b3b3b3b3b3b3b3b!2sAv.%20Imirim%2C%202850%20-%20Imirim%2C%20S%C3%A3o%20Paulo%20-%20SP%2C%2002465-600!5e0!3m2!1spt-BR!2sbr!4v1234567890123!5m2!1spt-BR!2sbr" width="100%" height="100%" style={{
                      border: 0
